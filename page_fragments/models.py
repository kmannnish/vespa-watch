...
class PageFragment(models.Model):
    ...
    def get_content_in(self, language_code):
        ...
        content_in_fallback_language = getattr(self,
                                               PageFragment._get_content_field_name(settings.PAGE_FRAGMENTS_FALLBACK_LANGUAGE))

        translated_content = getattr(self, PageFragment._get_content_field_name(language_code), content_in_fallback_language)
